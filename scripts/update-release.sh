...
git commit -S -m "Update ${VERSION_ENV} release" -m "version: ${VERSION}" -m "version-env: ${VERSION_ENV}" -m "version-range: ${VERSION_RANGE}" -m "${VERSION_TEXT}" -m "Commit: ${PHAR_COMMIT}"
